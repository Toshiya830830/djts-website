...
const services = [
  ...
  { num: '05', icon: '🎬', title: '動画編集',           desc: 'YouTube・SNS・広告用の動画をプロが編集。ブランドの世界観を映像で表現し、エンゲージメントを高めます。', href: '/services#video', last: true },
]
    ...
    <>
      ...
      <section className={s.hero}>
        ...
        <div className={`${s.heroContent} anim-1`}>
          ...
          <h1 className={`${s.heroTitle} anim-2`}>
            デジタルで、<br />
            ビジネスを<em className={s.heroAccent}>加速</em>する。
          </h1>
      ...
      <section className={s.services}>
        ...
        <div className={s.servicesGrid}>
          {services.map((sv) => (
            <div key={sv.num} className={`${s.serviceCard}${sv.last ? ' svc-last' : ''}`}>
